...
import pygame
from pygame import *
from src.Graph.DiGraph import *
from src.Graph.GraphAlgo import *
...
#     pokemons = []
#     for pok in pokemons_obj ['POKE']:
#         pokemons.append(Pokemon(pok['POK']))
#         return pokemons
#
...
# print(pokemons)
load = json.loads(client.get_graph())
# print(load)
# algo = GraphAlgo()
graph_json = client.get_graph()
# load = algo.load_from_json(graph_json)
print(load)
